...
stored in the inventory service. The `properties` link is used to link to the properties service
...
Then, to cleanup and rebuild and run the tests, run the `clean` and `install` goals:
