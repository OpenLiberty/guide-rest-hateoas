...
more about this service and how to build it by visiting https://openliberty.io/guides/rest-hateoas.html[Creating a Hypermedia-driven RESTful web service].
