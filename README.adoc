...
Take a look at the [hotspot=17-38 file=0]`request handlers` in the [hotspot file=0]`src/main/java/io/openliberty/guides/microprofile/InventoryResource.java` file.
