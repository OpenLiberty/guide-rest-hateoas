...
of which are used to navigate your REST service. You'll be building on top of a
https://github.com/OpenLiberty/guide-microprofile-intro[MicroProfile application],
...
them in the link:guides/microprofile-intro.html[MicroProfile guide].
...
```
# If servers are still running from previous steps, stop them first
