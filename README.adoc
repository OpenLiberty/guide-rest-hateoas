...
Take a look at the request handlers in the [hotspot file=0]`InventoryResource.java` file.
...
The [hotspot=Before]`@BeforeEach` and [hotspot=After]`@AfterEach` annotations are placed on setup and teardown tasks run for each individual test.
