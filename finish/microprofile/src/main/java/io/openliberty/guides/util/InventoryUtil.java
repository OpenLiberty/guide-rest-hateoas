...
public class InventoryUtil {
    ...
    // tag::buildHostJson[]
    public static JsonObject buildHostJson(String hostname, String invUri) {
        return Json.createObjectBuilder()
                   .add("hostname", hostname)
                   .add("_links", InventoryUtil.buildLinksForHost(hostname, invUri))
                   .build();
    }
    // end::buildHostJson[]
    ...
    public static JsonArray buildLinksForHost(String hostname, String invUri) {
        ...
        // tag::props[]
        // checking if the properties resource is live
    ...
    private static URI buildUri(String hostname) {
        return UriBuilder.fromUri("/LibertyProject/System/properties")
                         .host(hostname)
                         .port(PORT)
                         .scheme(PROTOCOL)
                         .build();
